	...
	render() {
		...
		switch ( icon ) {
			...
			case 'backup':
				...
				break;
			case 'bank':
				path = 'M10 2L3 6v1h14V6l-7-4zM5 8l-.2 7h2.5L7 8H5zm4 0l-.2 7h2.5L11 8H9zm4 0l-.2 7h2.5L15 8h-2zM3 18h14v-2H3v2z';
				break;
			case 'beer':
				path = 'M13.8 9.3c-.8-.1-1.5-.4-2-1s-.9-1.3-1-2c-.4-.1-.7-.3-1-.6-.4-.5-.6-1-.7-1.5l-.9.9-.8-.7c-.6-.7-1.7-.7-2.4 0L2.5 6.9c-.7.7-.7 1.8 0 2.5l.7.8-.6.6c-.7.7-.7 1.8 0 2.5l4.3 4.3c.7.7 1.8.7 2.4 0l6.4-6.5c-.5-.1-1-.3-1.4-.7-.1-.4-.3-.8-.5-1.1zM3.6 7.6l2-2c.3-.3.8-.3 1 0l.5.5-2.9 3.1-.6-.6c-.2-.3-.2-.7 0-1zm.6 4.7c-.3-.3-.3-.7 0-.9L8.5 7c.3-.3.7-.3.9 0 .3.3.3.7 0 .9l-4.3 4.3c-.3.3-.7.3-.9.1zM6 14.1c-.3-.3-.3-.7 0-.9l4.3-4.3c.3-.3.7-.3.9 0 .3.3.3.7 0 .9l-4.3 4.3c-.2.3-.6.3-.9 0zm7.1-2.5L8.8 16c-.3.3-.7.3-.9 0-.3-.3-.3-.7 0-.9l4.3-4.3c.3-.3.7-.3.9 0 .2.1.2.6 0 .8zm4.4-4.4c-.2-.2-.5-.4-.7-.4.4-1 .2-2.2-.6-2.9-.8-.8-1.9-1-2.9-.6-.1-.3-.3-.6-.5-.8-.7-.7-1.8-.7-2.4 0-.7.7-.7 1.8 0 2.5.3.3.8.5 1.2.5-.1.8.2 1.6.8 2.2.6.6 1.4.8 2.2.8 0 .5.2.9.5 1.2.7.7 1.8.7 2.4 0 .7-.7.7-1.8 0-2.5z';
				break;
			case 'bell':
				path = 'M10 18c1.1 0 2-.9 2-2H8c0 1.1.9 2 2 2zm4-8.2V7.5c0-1.8-1.2-3.4-3-3.9.1-.2.1-.4.2-.5-.1-.6-.6-1.1-1.2-1.1s-1.1.5-1.1 1.1c0 .2.1.4.2.5-1.8.4-3 2-3 3.9v2.2c-.1 1.2-.9 2.3-2 2.8V15h12v-2.5c-1.2-.4-2-1.5-2.1-2.7z';
				break;
			case 'block-default':
			...
			case 'buddicons-bbpress-logo':
				path = 'M4.5 6.2C3.7 7.3 3.3 8.6 3.3 10c0 1 .2 1.9.6 2.8l1-4.6c.3-1.7.4-2-.4-2zm4 6.4c.3-1.3 0-2.3-1.1-2.3-.8 0-1.6.6-1.8 1.5l-.3 1.7c-.3 1 .3 1.5 1 1.5 1.2 0 1.9-1.1 2.2-2.4zM10 2c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 15.5c-2.1 0-4-.8-5.3-2.2-.3-.4-.7-.8-1-1.2-.7-1.2-1.2-2.6-1.2-4.1 0-4.1 3.4-7.5 7.5-7.5s7.5 3.4 7.5 7.5-3.4 7.5-7.5 7.5zm3.8-4.9c.3-1.3 0-2.3-1.1-2.3-.8 0-1.6.6-1.8 1.5l-.4 1.7c-.2 1.1.4 1.6 1.1 1.6 1.1-.1 1.9-1.2 2.2-2.5zM10 3.3c-2 0-3.9.9-5.1 2.3.6-.1 1.4-.2 1.8-.3.2 0 .2.1.2.2 0 .2-1 4.8-1 4.8.5-.3 1.2-.7 1.8-.7.9 0 1.5.4 1.9.9l.5-2.4c.4-1.6.4-1.9-.4-1.9-.4 0-.4-.5 0-.6.6-.1 1.8-.2 2.3-.3.2 0 .2.1.2.2l-1 4.8c.5-.4 1.2-.7 1.9-.7 1.7 0 2.5 1.3 2.1 3-.3 1.7-2 3-3.8 3-1.3 0-2.1-.7-2.3-1.4-.7.8-1.7 1.3-2.8 1.4 1.1.7 2.4 1.1 3.7 1.1 3.7 0 6.7-3 6.7-6.7s-3-6.7-6.7-6.7z';
				break;
			...
			case 'building':
				...
				break;
			case 'businessman':
				path = 'M17 16.9v-2.5c0-.7-.1-1.4-.5-2.1-.4-.7-.9-1.3-1.6-1.7-.7-.5-2.2-.6-2.9-.6l-1.6 1.7.6 1.3v3l-1 1.1L9 16v-3l.7-1.3L8 10c-.8 0-2.3.1-3 .6-.7.4-1.1 1-1.5 1.7S3 13.6 3 14.4v2.5S5.6 18 10 18s7-1.1 7-1.1zM10 2.1c-1.9 0-3 1.8-2.7 3.8.3 2 1.3 3.4 2.7 3.4s2.4-1.4 2.7-3.4c.3-2.1-.8-3.8-2.7-3.8z';
				break;
			case 'businessperson':
				path = 'M13.2 10L11 13l-1-1.4L9 13l-2.2-3C3 11 3 13 3 16.9c0 0 3 1.1 6.4 1.1h1.2c3.4-.1 6.4-1.1 6.4-1.1 0-3.9 0-5.9-3.8-6.9zm-3.2.7L8.4 10l1.6 1.6 1.6-1.6-1.6.7zM10 2.1c-1.9 0-3 1.8-2.7 3.8.3 2 1.3 3.4 2.7 3.4s2.4-1.4 2.7-3.4c.3-2.1-.8-3.8-2.7-3.8z';
				break;
			case 'businesswoman':
				path = 'M10 11l-2.3-1 2.3 5.8 2.3-5.8';
				break;
			case 'button':
				...
				break;
			case 'calculator':
				path = 'M15 2H5c-.6 0-1 .4-1 1v14c0 .6.4 1 1 1h10c.6 0 1-.4 1-1V3c0-.6-.4-1-1-1zM6.5 16.8c-.7 0-1.2-.6-1.2-1.2s.6-1.2 1.2-1.2 1.2.6 1.2 1.2-.5 1.2-1.2 1.2zm0-3.6c-.7 0-1.2-.6-1.2-1.2s.6-1.2 1.2-1.2 1.2.6 1.2 1.2-.5 1.2-1.2 1.2zm0-3.4c-.7 0-1.2-.6-1.2-1.2s.6-1.2 1.2-1.2 1.2.6 1.2 1.2-.5 1.2-1.2 1.2zm3.5 7c-.7 0-1.2-.6-1.2-1.2s.6-1.2 1.2-1.2 1.2.6 1.2 1.2-.5 1.2-1.2 1.2zm0-3.6c-.7 0-1.2-.6-1.2-1.2s.6-1.2 1.2-1.2 1.2.6 1.2 1.2-.5 1.2-1.2 1.2zm0-3.4c-.7 0-1.2-.6-1.2-1.2s.5-1.4 1.2-1.4 1.2.6 1.2 1.2-.5 1.4-1.2 1.4zm4.8 5.7c0 .7-.6 1.2-1.2 1.2s-1.2-.6-1.2-1.2V12c0-.7.6-1.2 1.2-1.2s1.2.6 1.2 1.2v3.5zm-1.3-5.7c-.7 0-1.2-.6-1.2-1.2s.6-1.2 1.2-1.2 1.2.6 1.2 1.2-.5 1.2-1.2 1.2zM15 6.4H5V3h10v3.4z';
				break;
			case 'calendar-alt':
			...
			case 'calendar':
				...
				break;
			case 'camera-alt':
				path = 'M15 4h2.94c.59 0 1.06.47 1.06 1.06v11.81c0 .59-.47 1.13-1.06 1.13H2.06C1.47 18 1 17.46 1 16.87V5.06C1 4.47 1.47 4 2.06 4H5l3-2h4zm-5 11c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4z';
				break;
			case 'camera':
				path = 'M6 5V3H3v2h3zm12 10V4H9L7 6H2v9h16zm-7-8c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3z';
				break;
			case 'car':
				path = '"Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><style>.st0{fill:#00000A;}</style><circle class="st0" cx="14" cy="13.5" r="1.5"/><path class="st0" d="M16.1 9h-1.6c-.6-2.7-3.2-4.5-5.9-3.9C6.6 5.5 5 7 4.6 9h-.7c-1 0-1.9.9-1.9 1.9v1.3c0 .7.6 1.3 1.3 1.3h.3c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4h3.2c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4h.3c.7 0 1.3-.6 1.3-1.3V11c0-1.1-.9-2-1.9-2zM6.2 9c.5-1.9 2.5-2.9 4.3-2.4 1.1.3 2 1.2 2.4 2.4H6.2zM6 12c-.8 0-1.5.7-1.5 1.5S5.2 15 6 15s1.5-.7 1.5-1.5S6.8 12 6 12z';
				break;
			case 'carrot':
			...
			case 'cloud-upload':
				...
				break;
			case 'cloud':
				path = 'M14.9 9c0-.3.1-.6.1-1 0-2.2-1.8-4-4-4-1.6 0-2.9.9-3.6 2.2-.2-.1-.6-.2-.9-.2C5.1 6 4 7.1 4 8.5c0 .2 0 .4.1.5-1.8.3-3.1 1.7-3.1 3.5C1 14.4 2.6 16 4.5 16h10c1.9 0 3.5-1.6 3.5-3.5 0-1.8-1.3-3.3-3.1-3.5z';
				break;
			case 'code-standards':
				path = 'M6.1 9.5V8.4c0-.5-.2-.7-.7-.8.6-.1.8-.3.8-.9V5.6c0-.4.1-.5.7-.5h.3v-.5h-.6c-.9 0-1.3.2-1.3 1 0 .5.1.8.1 1.2 0 .2-.2.5-.9.5v.6c.7 0 .9.3.9.5 0 .4-.1.7-.1 1.2 0 .8.4 1 1.3 1h.5V10h-.3c-.5 0-.7-.1-.7-.5zm10.4 4.4c-.8-.8-1.7-1.4-2.6-2-.1-.1-1.1-1.1-1.5-1.4 2.4-4-1.1-9.2-5.7-8.5-4.4.7-6.3 6.2-3.2 9.4 1.7 1.9 4.6 2.3 6.9 1.1.6.6 1.1 1.1 1.6 1.7.7.9 1.2 1.8 2.1 2.5.6.5 1.4 1.2 2.3 1.3 1.1.1 1.7-.6 1.7-1.6-.1-.9-1-1.9-1.6-2.5zm-8.9-2.3c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4-1.8 4-4 4zm2.1-4.8c0-.4.1-.7.1-1.2 0-.8-.4-1-1.3-1H8v.5h.3c.5 0 .7.1.7.5v1.1c0 .5.2.7.7.8-.6.2-.8.4-.8.9v1.1c.1.4-.1.5-.6.5H8v.6h.5c.9 0 1.3-.2 1.3-1 0-.5-.1-.8-.1-1.2 0-.2.2-.5.9-.5v-.6c-.7 0-.9-.3-.9-.5z';
				break;
			case 'coffee':
				path = 'M4 15c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2H4zm2-3.8v.8c0 1.1.9 2 2 2h7c1.1 0 2-.9 2-2V4H5.6C3.6 4 2 5.4 2 7.6c0 2.3 1.6 3.6 3.6 3.6H6zM3.9 7.6c0-1 .7-1.8 1.7-1.8H6v3.6h-.4c-1 0-1.7-.7-1.7-1.8z';
				break;
			case 'color-picker':
				path = 'M17.8 2.2c-1-1-2.6-1-3.6 0L12.4 4l-.7-.7c-.4-.4-1-.4-1.4 0l-.8.7c-.4.4-.4 1 0 1.4l5 5c.4.4 1 .4 1.4 0l.7-.7c.4-.4.4-1 0-1.4l-.6-.7 1.8-1.8c1-1 1-2.6 0-3.6zM4.4 12c-2.2 2.2-.9 3.2-2.9 5.8l.7.7c2.6-2 3.6-.7 5.8-2.9l5.1-5.1-3.6-3.6L4.4 12z';
				break;
			case 'columns':
			...
			case 'database-view':
				...
				break;
			case 'database':
				path = 'M10 6c3.9 0 7-.9 7-2s-3.1-2-7-2-7 .9-7 2 3.1 2 7 2zm0 9c-3.9 0-7-.9-7-2v3c0 1.1 3.1 2 7 2s7-.9 7-2v-3c0 1.1-3.1 2-7 2zm0-4c-3.9 0-7-.9-7-2v3c0 1.1 3.1 2 7 2s7-.9 7-2V9c0 1.1-3.1 2-7 2zm0-4c-3.9 0-7-.9-7-2v3c0 1.1 3.1 2 7 2s7-.9 7-2V5c0 1.1-3.1 2-7 2z';
				break;
			case 'desktop':
			...
			case 'download':
				...
				break;
			case 'drumstick':
				path = 'M17.2 4.5c-.4-.7-1-1.2-1.6-1.6C13 1.3 9.7 2 8.1 4.5c-.5.8-.8 1.8-.8 2.7 0 1.5-.6 3-1.6 4.1l-.8.8c-.5.5-1.9.2-2.5 1.2-1.1 1.9.7 2.6 1.2 3.1s1.2 2.4 3.1 1.2c.9-.6.6-1.9 1.2-2.5l.8-.8c1.1-1 2.6-1.6 4.1-1.6.3 0 .6 0 .8-.1-.8-1.6-.2-3.5 1.3-4.3.9-.5 2.1-.5 3 0 .3-1.3 0-2.7-.7-3.8z';
				break;
			case 'edit-large':
				path = 'M6.4 14.1l1.3 1.3 6.9-6.9-1.3-1.3-6.9 6.9zm6.3-7.5l-1.3-1.3-6.9 6.9 1.4 1.4 6.8-7zm2.1-4.7l3.3 3.3c.6.6.5 1.5 0 2l-9.9 9.9-6.9 1.4 1.4-6.9c6.2-6.3 9.5-9.6 9.9-9.9.6-.4 1.6-.4 2.2.2z';
				break;
			case 'edit-page':
				path = 'M4 5H2v13h10v-2H4V5zm13.9-1.6l-1.3-1.3c-.4-.4-1.1-.5-1.6-.1l-1 1H5v12h9V9l4-4c.4-.5.3-1.2-.1-1.6zm-5.7 6l-2.5.9.9-2.5L15 3.4 16.6 5l-4.4 4.4z';
				break;
			case 'edit':
			...
			case 'editor-kitchensink':
				...
				break;
			case 'editor-ltr':
				path = 'M13 2H5.5C3 2 1 4 1 6.5S3 11 5.5 11H6v6c0 .5.5 1 1 1s1-.5 1-1V5c0-.5.5-1 1-1s1 .5 1 1v12c0 .5.5 1 1 1s1-.5 1-1V4h1c.5 0 1-.5 1-1s-.5-1-1-1zm1 4v8l5-4-5-4z';
				break;
			case 'editor-ol-rtl':
				path = 'M15 8.8c.1-.1.3-.1.4-.1.1 0 .3 0 .4.1.1.1.2.2.2.3 0 .1 0 .2-.1.3 0 .1-.1.2-.2.3l-.6.6-1 1v.7h2.8v-.7h-1.7l.5-.5.7-.7c.1-.1.2-.3.3-.5.1-.2.1-.3.1-.5s-.1-.4-.2-.6c-.1-.2-.3-.3-.4-.4-.2-.1-.4-.2-.7-.1-.2 0-.3 0-.5.1-.1 0-.3.1-.4.1-.2.1-.3.2-.5.4l.5.4c.1-.1.3-.2.4-.2zm1.7 6.5c-.2-.2-.5-.3-.7-.3.3-.1.5-.2.6-.4.2-.2.2-.4.2-.6 0-.3-.1-.6-.4-.7-.3-.2-.6-.3-1-.3-.5 0-.9.1-1.3.4l.4.6c.1-.1.3-.2.5-.2.1 0 .3-.1.4-.1.4 0 .6.2.6.5 0 .2-.1.3-.2.4-.2.1-.5.1-.7.1h-.3v.7h.3c.3 0 .5 0 .8.1.2.1.2.2.2.4s-.1.4-.2.5c-.2.1-.4.2-.6.2-.2 0-.4 0-.6-.1-.2 0-.4-.1-.5-.2v.7c.4.2.8.2 1.2.2.4 0 .9-.1 1.2-.3.3-.2.4-.6.4-.9 0-.3-.1-.5-.3-.7zM15 4.2c.1 0 .2-.1.3-.3V7h.8V3h-.7l-1.3 1 .4.5.5-.3zM4 6h9V5H4v1zm0 5h9v-1H4v1zm0 5h9v-1H4v1z';
				break;
			case 'editor-ol':
			...
			case 'editor-removeformatting':
				...
				break;
			case 'editor-rtl':
				path = 'M13 2H5.5C3 2 1 4 1 6.5S3 11 5.5 11H6v6c0 .5.5 1 1 1s1-.5 1-1V5c0-.5.5-1 1-1s1 .5 1 1v12c0 .5.5 1 1 1s1-.5 1-1V4h1c.5 0 1-.5 1-1s-.5-1-1-1zm1 8l5 4V6l-5 4z';
				break;
			...
			case 'email-alt':
				...
				break;
			case 'email-alt2':
				path = 'M16 1.1L4 5.9c-1.1.4-2 1.8-2 3v8.7c0 1.2.9 1.8 2 1.4l12-4.8c1.1-.4 2-1.8 2-3V2.5c0-1.2-.9-1.8-2-1.4zm.6 2.6l-6 9.3-6.7-4.5c-.1-.1-.4-.4-.2-.7.2-.4.7-.2.7-.2l6.3 2.3s4.8-6.3 5.1-6.7c.1-.2.4-.3.7-.1.3.2.2.5.1.6z';
				break;
			case 'email':
			...
			case 'flag':
				...
				break;
			case 'food':
				path = 'M7 4.5c-.3 0-.5.3-.5.5v2.5h-1V5c0-.3-.2-.5-.5-.5s-.5.3-.5.5v2.5h-1V5c0-.3-.2-.5-.5-.5s-.5.3-.5.5v3.3c0 .9.7 1.6 1.5 1.7v7c0 .6.4 1 1 1s1-.4 1-1v-7c.8-.1 1.5-.8 1.5-1.7V5c0-.2-.2-.5-.5-.5zM9 5v6h1v6c0 .6.4 1 1 1s1-.4 1-1V2c-1.7 0-3 1.3-3 3zm7-1c-1.4 0-2.5 1.5-2.5 3.3-.1 1.2.5 2.3 1.5 3V17c0 .6.4 1 1 1s1-.4 1-1v-6.7c1-.7 1.6-1.8 1.5-3C18.5 5.5 17.4 4 16 4z';
				break;
			case 'format-aside':
			...
			case 'forms':
				...
				break;
			case 'fullscreen-alt':
				path = 'M7 2H2v5l1.8-1.8L6.5 8 8 6.5 5.2 3.8 7 2zm6 0l1.8 1.8L12 6.5 13.5 8l2.7-2.7L18 7V2h-5zm.5 10L12 13.5l2.7 2.7L13 18h5v-5l-1.8 1.8-2.7-2.8zm-7 0l-2.7 2.7L2 13v5h5l-1.8-1.8L8 13.5 6.5 12z';
				break;
			case 'fullscreen-exit-alt':
				path = 'M3.4 2L2 3.4l2.8 2.8L3 8h5V3L6.2 4.8 3.4 2zm11.8 4.2L18 3.4 16.6 2l-2.8 2.8L12 3v5h5l-1.8-1.8zM4.8 13.8L2 16.6 3.4 18l2.8-2.8L8 17v-5H3l1.8 1.8zM17 12h-5v5l1.8-1.8 2.8 2.8 1.4-1.4-2.8-2.8L17 12z';
				break;
			case 'games':
				path = 'M15.9 5.5C15.3 4.5 14.2 4 13 4H7c-1.2 0-2.3.5-2.9 1.5-2.3 3.5-2.8 8.8-1.2 9.9 1.6 1.1 5.2-3.7 7.1-3.7s5.4 4.8 7.1 3.7c1.6-1.1 1.1-6.4-1.2-9.9zM8 9H7v1H6V9H5V8h1V7h1v1h1v1zm5.4.5c0 .5-.4.9-.9.9s-.9-.4-.9-.9.4-.9.9-.9.9.4.9.9zm1.9-2c0 .5-.4.9-.9.9s-.9-.4-.9-.9.4-.9.9-.9.9.4.9.9z';
				break;
			case 'google':
				path = '"Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><style>.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><path class="st0" d="M17.6 8.5h-7.5v3h4.4c-.4 2.1-2.3 3.5-4.4 3.4-2.6-.1-4.6-2.1-4.7-4.7-.1-2.7 2-5 4.7-5.1 1.1 0 2.2.4 3.1 1.2l2.3-2.2C14.1 2.7 12.1 2 10.2 2c-4.4 0-8 3.6-8 8s3.6 8 8 8c4.6 0 7.7-3.2 7.7-7.8-.1-.6-.1-1.1-.3-1.7z';
				break;
			case 'googleplus':
				path = '"Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><style>.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><path class="st0" d="M17.6 8.5h-7.5v3h4.4c-.4 2.1-2.3 3.5-4.4 3.4-2.6-.1-4.6-2.1-4.7-4.7-.1-2.7 2-5 4.7-5.1 1.1 0 2.2.4 3.1 1.2l2.3-2.2C14.1 2.7 12.1 2 10.2 2c-4.4 0-8 3.6-8 8s3.6 8 8 8c4.6 0 7.7-3.2 7.7-7.8-.1-.6-.1-1.1-.3-1.7z';
				break;
			...
			case 'heart':
				...
				break;
			case 'hidden':
				path = 'M17.3 3.3c-.4-.4-1.1-.4-1.6 0l-2.4 2.4c-1.1-.4-2.2-.6-3.3-.6-3.8.1-7.2 2.1-9 5.4.2.4.5.8.8 1.2.8 1.1 1.8 2 2.9 2.7L3 16.1c-.4.4-.5 1.1 0 1.6.4.4 1.1.5 1.6 0L17.3 4.9c.4-.5.4-1.2 0-1.6zm-10.6 9l-1.3 1.3c-1.2-.7-2.3-1.7-3.1-2.9C3.5 9 5.1 7.8 7 7.2c-1.3 1.4-1.4 3.6-.3 5.1zM10.1 9c-.5-.5-.4-1.3.1-1.8.5-.4 1.2-.4 1.7 0L10.1 9zm8.2.5c-.5-.7-1.1-1.4-1.8-1.9l-1 1c.8.6 1.5 1.3 2.1 2.2C15.9 13.4 13 15 9.9 15h-.8l-1 1c.7-.1 1.3 0 1.9 0 3.3 0 6.4-1.6 8.3-4.3.3-.4.5-.8.8-1.2-.3-.3-.5-.7-.8-1zM14 10l-4 4c2.2 0 4-1.8 4-4z';
				break;
			case 'hourglass':
				path = 'M15.5 16H15c-.1-2.5-.6-4.4-3.3-6 2.6-1.6 3.2-3.5 3.3-6h.5c.6 0 1-.4 1-1s-.4-1-1-1h-11c-.6 0-1 .4-1 1s.4 1 1 1H5c.1 2.5.6 4.4 3.3 6-2.6 1.6-3.2 3.5-3.3 6h-.5c-.6 0-1 .4-1 1s.4 1 1 1h11c.6 0 1-.4 1-1s-.4-1-1-1z';
				break;
			case 'html':
			...
			case 'insert-before':
				...
				break;
			case 'insert':
				path = 'ns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><path class="st0" d="M10 1c-5 0-9 4-9 9s4 9 9 9 9-4 9-9-4-9-9-9zm0 16c-3.9 0-7-3.1-7-7s3.1-7 7-7 7 3.1 7 7-3.1 7-7 7zm1-11H9v3H6v2h3v3h2v-3h3V9h-3V6z';
				break;
			case 'instagram':
				path = 'M12.7 10c0-1.5-1.2-2.7-2.7-2.7S7.3 8.5 7.3 10s1.2 2.7 2.7 2.7c1.5 0 2.7-1.2 2.7-2.7zm1.4 0c0 2.3-1.8 4.1-4.1 4.1S5.9 12.3 5.9 10 7.7 5.9 10 5.9s4.1 1.8 4.1 4.1zm1.1-4.3c0 .6-.4 1-1 1s-1-.4-1-1 .4-1 1-1 1 .5 1 1zM10 3.4c-1.2 0-3.7-.1-4.7.3-.7.3-1.3.9-1.5 1.6-.4 1-.3 3.5-.3 4.7s-.1 3.7.3 4.7c.2.7.8 1.3 1.5 1.5 1 .4 3.6.3 4.7.3s3.7.1 4.7-.3c.7-.3 1.2-.8 1.5-1.5.4-1.1.3-3.6.3-4.7s.1-3.7-.3-4.7c-.2-.7-.8-1.3-1.5-1.5-1-.5-3.5-.4-4.7-.4zm8 6.6v3.3c0 1.2-.4 2.4-1.3 3.4-.9.9-2.1 1.3-3.4 1.3H6.7c-1.2 0-2.4-.4-3.4-1.3-.8-.9-1.3-2.1-1.3-3.4V10 6.7c0-1.3.5-2.5 1.3-3.4C4.3 2.5 5.5 2 6.7 2h6.6c1.2 0 2.4.4 3.4 1.3.8.9 1.3 2.1 1.3 3.4V10z';
				break;
			case 'laptop':
			...
			case 'location':
				...
				break;
			case 'lock-duplicate':
				path = 'M15 9h-1V6c0-2.2-1.8-4-4-4S6 3.8 6 6v3H5c-.5 0-1 .5-1 1v7c0 .5.5 1 1 1h10c.5 0 1-.5 1-1v-7c0-.5-.5-1-1-1zm-4 7H9l.4-2.2c-.5-.2-.9-.8-.9-1.3 0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5c0 .6-.3 1.1-.9 1.3L11 16zm1-7H8V6c0-1.1.9-2 2-2s2 .9 2 2v3z';
				break;
			case 'lock':
				path = 'M15 9h-1V6c0-2.2-1.8-4-4-4S6 3.8 6 6v3H5c-.5 0-1 .5-1 1v7c0 .5.5 1 1 1h10c.5 0 1-.5 1-1v-7c0-.5-.5-1-1-1zm-4 7H9l.4-2.2c-.5-.2-.9-.8-.9-1.3 0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5c0 .6-.3 1.1-.9 1.3L11 16zm1-7H8V6c0-1.1.9-2 2-2s2 .9 2 2v3z';
				break;
			...
			case 'megaphone':
				...
				break;
			case 'menu-alt':
				path = 'M3 11h14V9H3v2zm0 5h14v-2H3v2zM3 4v2h14V4H3z';
				break;
			case 'menu-alt2':
				path = 'M5 15h10v-2H5v2zM5 5v2h10V5H5zm0 6h10V9H5v2z';
				break;
			case 'menu-alt3':
				path = 'M20 5V2H0v3h20zm0 6V8H0v3h20zm0 6v-3H0v3h20z';
				break;
			case 'menu':
				path = 'M3 15h14v-2H3v2zM3 5v2h14V5H3zm0 6h14V9H3v2z';
				break;
			case 'microphone':
			...
			case 'no':
				...
				break;
			case 'open-folder':
				path = 'M10.5 6l-2-2H2l.7 9.5L4.2 6h6.3zM5 7L3 17h13l2-10H5z';
				break;
			case 'palmtree':
			...
			case 'performance':
				...
				break;
			case 'pets':
				path = 'M11.9 8.4c1.3 0 2.1-1.9 2.1-3.1 0-1-.5-2.2-1.5-2.2-1.3 0-2.1 1.9-2.1 3.1 0 1 .5 2.2 1.5 2.2zm-3.8 0c1 0 1.5-1.2 1.5-2.2C9.6 4.9 8.8 3 7.5 3 6.5 3 6 4.2 6 5.2c-.1 1.3.7 3.2 2.1 3.2zm7.4-1c-1.3 0-2.2 1.8-2.2 3.1 0 .9.4 1.8 1.3 1.8 1.3 0 2.2-1.8 2.2-3.1 0-.9-.5-1.8-1.3-1.8zm-8.7 3.1c0-1.3-1-3.1-2.2-3.1-.9 0-1.3.9-1.3 1.8 0 1.3 1 3.1 2.2 3.1.9 0 1.3-.9 1.3-1.8zm3.2-.2c-2 0-4.7 3.2-4.7 5.4 0 1 .7 1.3 1.5 1.3 1.2 0 2.1-.8 3.2-.8 1 0 1.9.8 3 .8.8 0 1.7-.2 1.7-1.3 0-2.2-2.7-5.4-4.7-5.4z';
				break;
			case 'phone':
			...
			case 'pressthis':
				...
				break;
			case 'printer':
				path = 'M12 11H7v1h5v-1zm1 4H7v1h6v-1zm-3-2H7v1h3v-1zm7-7h-2V2H5v4H3c-.6 0-1 .4-1 1v5c0 .6.4 1 1 1h2v5h10v-5h2c.6 0 1-.4 1-1V7c0-.6-.4-1-1-1zm-3 11H6v-7h8v7zm0-11H6V3h8v3zm2 3h-1V8h1v1z';
				break;
			case 'privacy':
				path = 'M10 9.6c-.6 0-1 .4-1 1 0 .4.3.7.6.8l-.3 1.4h1.3l-.3-1.4c.4-.1.6-.4.6-.8.1-.6-.3-1-.9-1zm.1-4.3c-.7 0-1.4.5-1.4 1.2V8h2.7V6.5c-.1-.7-.6-1.2-1.3-1.2zM10 2L3 5v3c.1 4.4 2.9 8.3 7 9.9 4.1-1.6 6.9-5.5 7-9.9V5l-7-3zm4 11c0 .6-.4 1-1 1H7c-.6 0-1-.4-1-1V9c0-.6.4-1 1-1h.3V6.5C7.4 5.1 8.6 4 10 4c1.4 0 2.6 1.1 2.7 2.5V8h.3c.6 0 1 .4 1 1v4z';
				break;
			case 'products':
			...
			case 'randomize':
				...
				break;
			case 'reddit':
				path = 'M18 10.1c0-1-.8-1.8-1.8-1.7-.4 0-.9.2-1.2.5-1.4-.9-3-1.5-4.7-1.5l.8-3.8 2.6.6c0 .7.6 1.2 1.3 1.2.7 0 1.2-.6 1.2-1.3 0-.7-.6-1.2-1.3-1.2-.5 0-.9.3-1.1.7L11 2.9h-.2c-.1 0-.1.1-.1.2l-1 4.3C8 7.4 6.4 7.9 5 8.9c-.7-.7-1.8-.7-2.5 0s-.7 1.8 0 2.5c.1.1.3.3.5.3v.5c0 2.7 3.1 4.9 7 4.9s7-2.2 7-4.9v-.5c.6-.3 1-.9 1-1.6zM6 11.4c0-.7.6-1.2 1.2-1.2.7 0 1.2.6 1.2 1.2s-.6 1.2-1.2 1.2c-.7 0-1.2-.5-1.2-1.2zm7 3.3c-.9.6-1.9 1-3 .9-1.1 0-2.1-.3-3-.9-.1-.1-.1-.3 0-.5.1-.1.3-.1.4 0 .7.5 1.6.8 2.5.7.9.1 1.8-.2 2.5-.7.1-.1.3-.1.5 0s.2.3.1.5zm-.3-2.1c-.7 0-1.2-.6-1.2-1.2s.6-1.2 1.2-1.2c.7 0 1.2.6 1.2 1.2.1.7-.5 1.2-1.2 1.2z';
				break;
			case 'redo':
				path = 'ns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><path class="st0" d="M8 5h5V2l6 4-6 4V7H8c-2.2 0-4 1.8-4 4s1.8 4 4 4h5v2H8c-3.3 0-6-2.7-6-6s2.7-6 6-6z';
				break;
			case 'remove':
				path = 'ns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><path class="st0" d="M10 1c-5 0-9 4-9 9s4 9 9 9 9-4 9-9-4-9-9-9zm0 16c-3.9 0-7-3.1-7-7s3.1-7 7-7 7 3.1 7 7-3.1 7-7 7zM6 9v2h8V9H6z';
				break;
			case 'rest-api':
				path = 'M16 13c-1.3 0-2.4.8-2.8 2H9c0-.7-.2-1.3-.5-1.8l7.1-7.3c.3 0 .6.1.9.1C17.9 6 19 4.9 19 3.5S17.9 1 16.5 1 14 2.1 14 3.5c0 .3.1.7.2 1l-7 7.2c-.6-.5-1.4-.7-2.2-.7V6.8C6.2 6.4 7 5.3 7 4c0-1.7-1.3-3-3-3S1 2.3 1 4c0 1.3.8 2.4 2 2.8v4.7c-1.2.7-2 2-2 3.4 0 2.2 1.8 4 4 4 1.5 0 2.8-.8 3.4-2h4.7c.4 1.1 1.5 2 2.8 2 1.6 0 3-1.3 3-3C19 14.3 17.6 13 16 13z';
				break;
			case 'rss':
			...
			case 'store':
				...
				break;
			case 'superhero-alt':
				path = 'M15 5H5L2 8l8 8 8-8-3-3zm-3.3 6.9L10 11l-1.7.9.3-1.9-1.4-1.4 1.9-.3.9-1.7.9 1.8 1.9.3-1.4 1.3.3 1.9z';
				break;
			case 'superhero':
				path = 'M11.1 10L18 2 7 10h2l-7 8 11-8h-1.9zm-4.3 1H3.9l2.5-1.8 7.5-5.5L10 2 3 5v3c0 2 .5 3.9 1.5 5.6L6.8 11zm6.4-2H16l-2.4 1.8L6.5 16c1 .9 2.2 1.6 3.5 2 4.2-1.5 7.1-5.5 7-10V5l-.2-.1L13.2 9z';
				break;
			...
			case 'testimonial':
				...
				break;
			case 'text-page':
				path = 'M3 1v18h14V1H3zm9 13H6v-1h6v1zm2-3H6v-1h8v1zm0-3H6V7h8v1zm0-3H6V4h8v1z';
				break;
			case 'text':
			...
			case 'tickets':
				...
				break;
			case 'tide':
				path = 'M3 12.8V17h14V9.9c-2.5.6-4.8 1.6-7 3V10c-2.2 1.3-4.5 2.3-7 2.8zM17 3H3v7.1c2.5-.6 4.9-1.6 7-3.1v3c2.1-1.4 4.5-2.3 7-2.8V3z';
				break;
			case 'translation':
			...
			case 'trash':
				...
				break;
			case 'twitch':
				path = '"Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><style>.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><path class="st0" d="M2.7 2L2 4.6v11.8h3.2V18H7l1.8-1.6h2.9l5.7-5.2V2H2.7zM16 10.5l-2.5 2.3h-4l-2.2 2v-2H4.2V3.3H16v7.2zm-2.5-4.6h-1.4v3.9h1.4V5.9zm-4 0H8.1v3.9h1.4V5.9z';
				break;
			case 'twitter-alt':
				path = 'M13.9 13.8H8.5c-.2 0-.3-.1-.3-.4v-3h5.7c1.1 0 2.1-.9 2.1-2.1 0-1.2-1-2.1-2.1-2.1H8.2V4.1C8.2 2.9 7.2 2 6 2c-1.1 0-2 .9-2 2.1v9.2C4 16 5.5 17.9 8.6 18H14c1.1 0 2.1-1 2.1-2.1-.1-1.2-1.1-2.1-2.2-2.1z';
				break;
			case 'twitter':
				...
				break;
			case 'undo':
				path = 'ns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g><path class="st0" d="M12 5H7V2L1 6l6 4V7h5c2.2 0 4 1.8 4 4s-1.8 4-4 4H7v2h5c3.3 0 6-2.7 6-6s-2.7-6-6-6z';
				break;
			...
			case 'unlock':
				...
				break;
			case 'update-alt':
				path = 'M5.7 9c.4-2 2.2-3.5 4.3-3.5 1.5 0 2.7.7 3.5 1.8l1.7-2C14 3.9 12.1 3 10 3 6.5 3 3.6 5.6 3.1 9H1l3.5 4L8 9H5.7zm9.8-2L12 11h2.3c-.5 2-2.2 3.5-4.3 3.5-1.5 0-2.7-.7-3.5-1.8l-1.7 1.9C6 16.1 7.9 17 10 17c3.5 0 6.4-2.6 6.9-6H19l-3.5-4z';
				break;
			case 'update':
			...
			case 'welcome-write-blog':
				...
				break;
			case 'whatsapp':
				path = 'M16.8 5.7C14.4 2 9.5.9 5.7 3.2 2 5.5.8 10.5 3.2 14.2l.2.3-.8 3 3-.8.3.2c1.3.7 2.7 1.1 4.1 1.1 1.5 0 3-.4 4.3-1.2 3.7-2.4 4.8-7.3 2.5-11.1zm-2.1 7.7c-.4.6-.9 1-1.6 1.1-.4 0-.9.2-2.9-.6-1.7-.8-3.1-2.1-4.1-3.6-.6-.7-.9-1.6-1-2.5 0-.8.3-1.5.8-2 .2-.2.4-.3.6-.3H7c.2 0 .4 0 .5.4.2.5.7 1.7.7 1.8.1.1.1.3 0 .4.1.2 0 .4-.1.5-.1.1-.2.3-.3.4-.2.1-.3.3-.2.5.4.6.9 1.2 1.4 1.7.6.5 1.2.9 1.9 1.2.2.1.4.1.5-.1s.6-.7.8-.9c.2-.2.3-.2.5-.1l1.6.8c.2.1.4.2.5.3.1.3.1.7-.1 1z';
				break;
			case 'wordpress-alt':
				path = '"图层_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><style>.st0{fill:#040000;}</style><path class="st0" d="M10 .4C4.7.4.4 4.7.4 10s4.3 9.6 9.6 9.6 9.6-4.3 9.6-9.6S15.3.4 10 .4zM10 19c-5 0-9-4-9-9s4-9 9-9 9 4 9 9-4 9-9 9zm6-14c0 .6-.5 1.1-1.1 1.1s-1.1-.5-1.1-1.1.5-1.1 1.1-1.1S16 4.3 16 5zm-2.2 4.9c-.2-.9-.5-1.7-.7-2.5s-.5-1.4-.7-2c-.2-.4-.5-.7-.9-.8-.5-.2-1-.2-1.5-.2-.4 0-.8.1-1.2.2-.3 0-.6 0-.9.2-.1.2-.1.5-.3.9-.2.4-.3.9-.5 1.3-.1.5-.3 1.1-.5 1.6-.3.6-.4 1.2-.6 1.7l-.5 1.5c-.2.4-.2.8-.3 1.1l-.2.5v.5c0 .3.2.6.4.8.4.3.8.3 1.2.3h.7c.2-.1.3-.1.5-.2.2-.3.2-.7.3-1 .2-.3.2-.7.3-1h3.2l.3 1.2c0 .2.1.3.2.5s.2.3.3.4c.2.2.3.2.5.2.2.1.5.1.7.1.3 0 .6-.1 1-.2.2-.1.5-.2.6-.4-.2-.6-.4-1.4-.6-2.2-.3-.8-.5-1.6-.8-2.5zm-4.9.6c.1-.7.3-1.3.5-1.9.3-.5.4-1.1.6-1.6h.1c.2.5.3 1 .5 1.6.2.6.3 1.2.5 1.8H';
				break;
			case 'wordpress':
				path = 'M.2 10C.2 4.6 4.6.2 10 .2s9.8 4.4 9.8 9.8-4.4 9.8-9.9 9.8C4.6 19.8.2 15.4.2 10zm11.4 3c.1.5.2.9.4 1.3.1.4.2.8.7 1 .9.4 1.8.3 2.7-.2.2-.1.2-.2.2-.4-.9-3.2-1.9-6.3-2.8-9.5-.2-.7-.6-1-1.3-1.2-1.2-.3-2.4-.2-3.5.3-.1 0-.3.2-.3.3-.4.9-.7 1.8-1 2.6l-2.1 6.6c-.3.9.1 1.5 1 1.7.6.1 1.2.1 1.8-.1.2-.1.3-.2.4-.4.1-.6.3-1.2.5-1.8 0-.1.2-.2.3-.2h3zm3.6-7.3c.7 0 1.2-.5 1.2-1.2s-.5-1.2-1.2-1.2-1.2.5-1.2 1.2c.1.7.6 1.2 1.2 1.2zm-5.1 1.2H10c-.4 1.1-.8 2.3-1.2 3.6h2.3c-.3-1.3-.7-2.5-1-';
				break;
			case 'xing':
				path = 'M7.4 5.6c-.1-.3-.4-.4-.7-.4H4.4c-.2 0-.3.1-.4.3 0 .1 0 .2.1.2l1.6 2.7-2.5 4.3c-.1.1-.1.2 0 .4.1.1.2.2.3.2h2.3c.3 0 .5-.2.6-.4 0 0 2.4-4.2 2.5-4.4L7.4 5.6zm9.4-3.1c.1-.1.1-.2 0-.4-.1-.1-.2-.1-.3-.1h-2.3c-.3 0-.5.2-.6.4 0 0-5 8.8-5.1 9.1l3.3 6c.1.3.4.4.6.4h2.3c.1 0 .2 0 .3-.1.1-.1.1-.2 0-.3l-3.2-5.9 5-9.1z';
				break;
			case 'yes-alt':
			...
			case 'yes':
				...
				break;
			case 'youtube':
				path = 'M17.7 5.3c-.2-.7-.7-1.2-1.4-1.4-2.1-.2-4.2-.4-6.3-.3-2.1 0-4.2.1-6.3.3-.6.2-1.2.8-1.4 1.4C2.1 6.9 2 8.4 2 10s.1 3.1.3 4.7c.2.7.7 1.2 1.4 1.4 2.1.2 4.2.4 6.3.3 2.1 0 4.2-.1 6.3-.3.7-.2 1.2-.7 1.4-1.4.2-1.5.3-3.1.3-4.7s-.1-3.1-.3-4.7zM8 13V7l5.2 3L8 13z';
				break;
		}
